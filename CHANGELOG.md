...
* Güncel olmayan Flarum çekirdek çevirileri kaldırıldı ("2.0" veya üstü sürümler desteklenir).
* Güncel olmayan doğrulama çevirileri kaldırıldı (sürüm `2.0` veya üzeri desteklenir).
...
**Kullanımdan kalkmış uzantılar ve/veya güncel olmayan çeviriler kaldırıldı**:
...
**Kullanımdan kalkmış uzantılar kaldırıldı**:
...
Tüm değişiklikler: [1.45.6...2.0.0](https://github.com/flarum-lang/turkish/compare/1.45.6...2.0.0).
